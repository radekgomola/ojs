...
{*<tr valign="top">
	...
	<td width="80%" class="value"><textarea type="text" class="textField" name="citace[{$formLocale|escape}]" id="citace" value="{$citace[$formLocale]|escape}" rows="1" cols="60" />{$citace[$formLocale]|escape}</textarea></td>
</tr>*}
</table>
</div>
