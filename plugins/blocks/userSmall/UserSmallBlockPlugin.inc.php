...
/**
 * @file plugins/blocks/userSmall/UserSmallBlockPlugin.inc.php
 *
...
class UserSmallBlockPlugin extends BlockPlugin {
	...
	function getDisplayName() {
		return __('plugins.block.userSmall.displayName');
	}
	...
	function getDescription() {
		return __('plugins.block.userSmall.description');
	}
	...
	function getContents(&$templateMgr) {
		if (!defined('SESSION_DISABLE_INIT')) {
			...
			$loginUrl = Request::url(null, 'login', null);
			...
			$templateMgr->assign('userSmallBlockLoginUrl', $loginUrl);
		}
