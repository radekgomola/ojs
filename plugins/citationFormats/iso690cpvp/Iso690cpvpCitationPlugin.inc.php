...
/**
 * @file plugins/citationFormats/iso690cpvp/Iso690cpvpCitationPlugin.inc.php
 *
 ...
 *
 * @brief ISO 690 citation format plugin for Časopis pro právní vědu a praxi
 */

import('classes.plugins.CitationPlugin');

class Iso690cpvpCitationPlugin extends CitationPlugin {
	 ...
	 */
	function getName() {
		return 'Iso690cpvpCitationPlugin';
	}

	function getDisplayName() {
		return __('plugins.citationFormats.iso690cpvp.displayName');
	}

	function getCitationFormatName() {
		return __('plugins.citationFormats.iso690cpvp.citationFormatName');
	}

	function getDescription() {
		return __('plugins.citationFormats.iso690cpvp.description');
	}
}
