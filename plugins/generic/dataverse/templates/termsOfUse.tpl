...
<head>
	<title>{translate key="plugins.generic.dataverse.termsOfUse.dataverse"} {translate key="plugins.generic.dataverse.termsOfUse.title"}</title>
...
<div id="header">
<div id="headerTitle">
<h1>{translate key="plugins.generic.dataverse.termsOfUse.dataverse"}{if $currentJournal && $currentJournal->getLocalizedTitle()}:&nbsp;{$currentJournal->getLocalizedTitle()}{/if}</h1>
</div>
</div>
